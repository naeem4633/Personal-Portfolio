        ...
        <div className='mx-auto w-full lg:w-3/4 flex flex-col tracking-wider px-4 lg:px-0'>
            <div className='w-full lg:w-1/2 space-y-16 my-[15vh]'>
                <div className='flex flex-col space-y-8'>
                    <h1 className='text-7xl lg:text-[10rem]'>About</h1>
                    <div className='flex flex-col space-y-2 text-xl'>
                        <p className=''>I'm Ahmed, a web developer - </p> 
                        <p className='font-secondary ml-12 text-white'>blending creativity with code.</p>
                    </div>
                </div>
