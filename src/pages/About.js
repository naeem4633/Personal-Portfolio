...
const About = () => {
  return (
    <>
    <Header />
    <section className="w-full min-h-[100vh] bg-gray-950 flex items-center justify-center text-gray-300">
        <ResetPage />
        <div className='mx-auto w-3/4 flex flex-col tracking-wider'>
            <div className='w-1/2 space-y-16 my-[15vh]'>
                <div className='flex flex-col space-y-8'>
                    <h1 className='text-[10rem]'>About</h1>
                    <div className='flex flex-col space-y-2'>
                        <p className='text-4xl'>I'm Ahmed, a web developer - </p> 
                        <p className='font-secondary text-4xl ml-12 text-white'>blending creativity with code.</p>
                    </div>
                </div>
