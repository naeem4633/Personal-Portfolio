...
const Header = ({navigation, transparent}) => {
  return (
    <section className={transparent ? 'w-full fixed top-0 text-black tracking-wider bg-transparent' : 'w-full fixed top-0 text-gray-300 tracking-wider bg-gray-950'}>
        <div className='w-full flex flex-row justify-between items-center py-4 lg:py-2 px-4'>
            <Link className='' to={'/'}>
                <img className='w-20 h-16' src='../static/images/logo.png' alt=''></img>
            </Link>
            {navigation && (<ul className='w-full lg:w-auto justify-end lg:mx-0 flex flex-row space-x-5 text-sm'>
